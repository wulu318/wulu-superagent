...
This guide walks through testing the entire Web Search Skill integration with wulu.

## Prerequisites

1. wulu built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with wulu.

**Steps:**

1. Start wulu in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of wulu launch.
...
1. Open a terminal while wulu is running
...
**Objective:** Verify graceful shutdown of services when wulu quits.

**Steps:**

1. With wulu running and searches completed, quit the application
...
1. Start wulu (ensure headless is false in config)
