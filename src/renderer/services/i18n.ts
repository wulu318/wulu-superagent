...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    newApiQuota: '额度',
    // WULU Cloud
    wuluCloudTabTitle: 'WULU 云服务',
    wuluCloudEnabled: '启用 WULU 云服务',
    wuluCloudEnabledHint: '登录 WULU 云端获取订阅计划、额度管理和记忆同步',
    wuluCloudEmail: '邮箱',
    wuluCloudPassword: '密码',
    wuluCloudLogin: '登录',
    wuluCloudRegister: '注册',
    wuluCloudLogout: '退出登录',
    wuluCloudLoginSuccess: '登录成功',
    wuluCloudLoginFailed: '登录失败',
    wuluCloudRegisterSuccess: '注册成功',
    wuluCloudRegisterFailed: '注册失败',
    wuluCloudMissingFields: '请填写邮箱和密码',
    wuluCloudPasswordTooShort: '密码至少 6 位',
    wuluCloudSubscription: '订阅计划',
    wuluCloudQuotaRemaining: '剩余额度',
    wuluCloudQuotaTokens: 'tokens',
    wuluCloudNoSubscription: '暂无订阅',
    wuluCloudExpiresAt: '到期时间',
    wuluCloudModeTitle: '云端模式',
    wuluCloudModeDesc: '登录 WULU 云端，享受订阅计划、额度管理和云端记忆同步',
    wuluOfflineModeTitle: '离线模式',
    wuluOfflineModeDesc: '直接使用 API Key 连接 NewAPI 兼容后端，无需登录',
