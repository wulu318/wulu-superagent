...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 WULU Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '网易有道WULU服务协议',
    privacyDialogDesc: '在使用网易有道WULU之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '网易有道WULU服务协议',
  ...
  en: {
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao WULU Terms of Service',
    privacyDialogDesc:
      'Before using NetEase Youdao WULU, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NetEase Youdao WULU Terms of Service',
